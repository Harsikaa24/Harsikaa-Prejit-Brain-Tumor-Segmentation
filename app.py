...
st.markdown("<h1 style='text-align: center; color:#ffffff;'>Tumor Detection🥼🏥</h1>", unsafe_allow_html=True)
st.markdown("---")
st.markdown("<p style='font-size:20px;'>To detect your patient's tumor, upload your MRI.</p>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    # Display results
    st.markdown("<h2 style='color:#ffffff;'>🖼️ Segmentation Result</h2>", unsafe_allow_html=True)
